...
var App = function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.handleSetUser = _this.handleSetUser.bind(_this);
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      socket.on('newMessage', function (data) {
        _this2.setState({
          messages: [data].concat(_this2.state.messages)
        });
      });
    }
  }, {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          'Hi ',
          this.state.user,
          ', Welcome to Entelo Chat Room!'
        ),
        _react2.default.createElement('input', { value: this.state.userNameInput, onChange: this.handleUserChange }),
        _react2.default.createElement(
          'button',
          { type: 'button', onClick: this.handleSetUser },
          'Set New User Name'
        ),
        _react2.default.createElement('br', null),
        _react2.default.createElement('input', { value: this.state.input, onChange: this.handleInputChange }),
        _react2.default.createElement(
          'button',
          { type: 'button', onClick: this.handleSend },
          'Send'
        ),
        _react2.default.createElement(Messages, { messages: this.state.messages })
      );
    }
  }]);
...
var Messages = function Messages(props) {
  return _react2.default.createElement(
    ...
    props.messages.map(function (message, i) {
      return _react2.default.createElement(Message, { message: message, key: i });
    })
  );
};
...
*/
var aa=__webpack_require__(10),l=__webpack_require__(17),B=__webpack_require__(6),C=__webpack_require__(3),ba=__webpack_require__(18),da=__webpack_require__(19),ea=__webpack_require__(20),fa=__webpack_require__(21),ia=__webpack_require__(22),D=__webpack_require__(7);
